...
<!--              I AM NOT PROUD OF THIS BUT IT WORKED -->
              <strong class="text-xl">
                Start: {{ String(Number(event.start_time.slice(0, -6)) % (event.start_time.slice(0, -6) === '12' ? 13 : 12) ) + event.start_time.slice(2, -3) + (Number(event.start_time.slice(0, -6)) >= 12 ? ' pm' : ' am' ) }}
              </strong>
              <strong class="text-xl">
                End: {{ String(Number(event.end_time.slice(0, -6)) % (event.end_time.slice(0, -6) === '12' ? 13 : 12) ) + event.end_time.slice(2, -3) + (Number(event.end_time.slice(0, -6)) >= 12 ? ' pm' : ' am' ) }}
              </strong>
            </li>
