...
<!--            </li>-->
            <li class="flex flex-col items-center gap-2 mb-4">
              <strong class="text-xl">Start: {{ String(Number(event.start_time.slice(0, -6)) % 12) + event.start_time.slice(2, -3) }}</strong>
              <strong class="text-xl">End: {{ String(Number(event.end_time.slice(0, -6)) % 12) + event.end_time.slice(2, -3) }}</strong>
            </li>
